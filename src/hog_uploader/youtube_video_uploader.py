...
def create_youtube_service(credentials_file_path: str) -> Resource:
    flow = InstalledAppFlow.from_client_secrets_file(
        client_secrets_file=credentials_file_path, scopes=SCOPES
    )
...
class YoutubeVideoUploader:
    ...
    def upload_video_and_add_to_playlist(
        self, video_title: str, video_file_path: str, playlist_id: str
    ):
